        ...
        >
          ...
          <Card className="p-8 bg-gradient-to-br from-gray-50 to-emerald-50/30 dark:from-gray-800 dark:to-emerald-900/10 border-2 mb-12">
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
              I'm Jeffrey Hamlin Vinod, an MSc Computer Science (Data Science) candidate at Trinity College Dublin. I build end-to-end systems. From data pipelines and REST APIs to interactive dashboards, with a focus on clean and maintainable code that ships to production.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mt-4 text-justify">
              My dissertation explores reinforcement learning agent convergence. Alongside that, I designed and deployed a website for Ananda Stores which is a full-stack B2B e-commerce platform; solo from client requirements to live deployment on Vercel and Railway.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mt-4 text-justify">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <Card className="p-6 hover:shadow-xl transition-shadow duration-300 border-2 hover:border-emerald-200 dark:hover:border-emerald-800 dark:bg-gray-800/50">
